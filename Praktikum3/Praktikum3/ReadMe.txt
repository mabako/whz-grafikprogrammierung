================================================================================
 MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: Praktikum3-Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese Praktikum3-Anwendung für Sie 
...
finden, aus denen Ihre Praktikum3–Anwendung besteht.
...
Praktikum3.h
    ...
    die CPraktikum3App-Anwendungsklasse.

Praktikum3.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CPraktikum3App-
...
res\Praktikum3.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "Praktikum3.rc" 
    enthalten.
...
Praktikum3Dlg.h, Praktikum3Dlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CPraktikum3Dlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "Praktikum3.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "Praktikum3.pch.pch2 und eine 
